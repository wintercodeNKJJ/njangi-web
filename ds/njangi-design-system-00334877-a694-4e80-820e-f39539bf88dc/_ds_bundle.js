...
const __ds_ns = (window.NjangiDesignSystem_003348 = window.NjangiDesignSystem_003348 || {});
...
function Avatar({
  ...
  const hues = ['var(--clay-200)', 'var(--ochre-200)', 'var(--palm-200)', 'var(--hibiscus-200)', 'var(--indigo-200)'];
  ...
  return /*#__PURE__*/React.createElement("span", _extends({
    style: {
      ...
      boxShadow: ringColor ? `0 0 0 2px ${ringColor}` : 'var(--shadow-xs)',
      ...style
    }
  }, rest), !src && initials);
}
...
function Button({
  ...
  return /*#__PURE__*/React.createElement("button", _extends({
    ...
    name: icon,
    size: s.icon
  }) : icon), children, iconAfter && /*#__PURE__*/React.createElement(__ds_scope.Icon, {
    name: iconAfter,
    size: s.icon
  }));
}
...
function IconButton({
  ...
  return /*#__PURE__*/React.createElement("button", _extends({
    ...
    style: {
      ...
      background: t.bg,
      color: t.fg,
      boxShadow: tone === 'plain' ? 'var(--shadow-xs)' : tone === 'accent' ? 'var(--shadow-accent)' : 'none',
      cursor: 'pointer',
      transform: down ? 'scale(var(--press-scale))' : 'scale(1)',
...
function tileRadius(size) {
  const keys = Object.keys(TILE_RADIUS).map(Number).sort((a, b) => a - b);
...
function Logo({
  ...
  const mark = bg ? /*#__PURE__*/React.createElement("span", {
    style: {
      display: 'grid',
      placeItems: 'center',
      flex: 'none',
  ...
  }, "Njangi"), dot && /*#__PURE__*/React.createElement("span", {
    style: {
...
function SocialLinks({
  ...
  }, rest), networks.map(n => /*#__PURE__*/React.createElement("a", {
    key: n,
    href: "#",
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/core/SocialLogo.jsx", error: String((e && e.message) || e) }); }
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/data/IconTile.jsx", error: String((e && e.message) || e) }); }
...
function ListRow({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    style: {
      ...
      background: dark ? 'var(--cocoa-900)' : tone === 'inset' ? 'var(--bg-inset)' : tone === 'gold' ? 'var(--ochre-300)' : 'var(--white)',
      color: dark ? 'var(--cocoa-50)' : 'var(--text-body)',
      boxShadow: tone === 'inset' ? 'none' : hot && onClick ? 'var(--shadow-md)' : 'var(--shadow-xs)',
      cursor: onClick ? 'pointer' : 'default',
      transition: 'box-shadow var(--dur-base) var(--ease-standard)',
      ...style
    }
  }, rest), avatar, icon && !avatar && /*#__PURE__*/React.createElement(__ds_scope.IconTile, {
    icon: icon,
  ...
  }, subtitle)), right, value !== undefined && /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'right'
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, valueSub)), chevron && /*#__PURE__*/React.createElement(__ds_scope.Icon, {
    name: "chevron-right",
    size: 18,
    style: {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/data/PayLogo.jsx", error: String((e && e.message) || e) }); }
...
function ProgressRing({
  ...
  }, label ?? pct + '%'), sublabel && /*#__PURE__*/React.createElement("span", {
    style: {
...
function StatTile({
  ...
  }, rest), icon && /*#__PURE__*/React.createElement(__ds_scope.IconTile, {
    icon: icon,
    tone: iconTone || (tone === 'plain' || tone === 'inset' ? 'clay' : 'dark'),
    size: 34
...
function Timeline({
  ...
  if (orientation === 'horizontal') {
    return /*#__PURE__*/React.createElement("div", _extends({
      ...
      style: {
        flex: 1,
        height: 3,
        background: i === 0 ? 'transparent' : s.done ? 'var(--cocoa-900)' : 'var(--cocoa-200)'
      }
      ...
      style: {
        flex: 1,
        height: 3,
        background: i === steps.length - 1 ? 'transparent' : steps[i + 1] && steps[i + 1].done ? 'var(--cocoa-900)' : 'var(--cocoa-200)'
      }
    })), /*#__PURE__*/React.createElement("span", {
      style: {
        font: 'var(--type-caption)',
        fontWeight: 'var(--weight-semibold)',
        color: s.done || s.current ? 'var(--text-heading)' : 'var(--text-faint)',
        marginTop: 8,
        textAlign: 'center'
      }
  ...
  }, s.meta)), s.body && /*#__PURE__*/React.createElement("div", {
    style: {
      font: 'var(--type-body-sm)',
      color: 'var(--text-muted)',
      marginTop: 3
...
function Dot({
  ...
  return /*#__PURE__*/React.createElement("span", {
    style: {
      ...
      height: 22,
      borderRadius: 999,
      background: done ? 'var(--cocoa-900)' : current ? 'var(--accent-primary)' : 'var(--white)',
      border: `2px solid ${done ? 'var(--cocoa-900)' : current ? 'var(--accent-primary)' : 'var(--cocoa-200)'}`,
      color: 'var(--white)',
      boxSizing: 'border-box'
    }
  }, (done || current) && /*#__PURE__*/React.createElement(__ds_scope.Icon, {
    name: done ? 'check' : 'dot',
    size: 13
  }));
}
...
function Sheet({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      position: 'absolute',
      inset: 0,
      background: 'color-mix(in oklab, var(--cocoa-900) 42%, transparent)',
      backdropFilter: 'blur(3px)',
      animation: 'njangi-fade var(--dur-base) var(--ease-standard) both'
    }
    ...
    style: {
      ...
      animation: 'njangi-rise var(--dur-slow) var(--ease-entrance) both',
      ...style
    }
  }, rest), /*#__PURE__*/React.createElement("div", {
    style: {
...
function Toast({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    style: {
      ...
      font: 'var(--type-body-sm)',
      fontWeight: 'var(--weight-medium)',
      animation: 'njangi-rise var(--dur-base) var(--ease-entrance) both',
      ...style
    }
  }, rest), /*#__PURE__*/React.createElement(__ds_scope.Icon, {
    name: icon || t.icon,
...
function AmountField({
  ...
  })), quickAmounts && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 8,
      marginTop: 12,
  ...
  }, quickAmounts.map(a => /*#__PURE__*/React.createElement("button", {
    key: a,
...
function Input({
  ...
  const bd = error ? 'var(--status-danger)' : focus ? 'var(--border-focus)' : 'var(--border-default)';
  return /*#__PURE__*/React.createElement("label", {
    ...
    style: {
      ...
      height: h,
      padding: '0 16px',
      background: tone === 'inset' ? 'var(--bg-inset)' : 'var(--white)',
...
function Switch({
  ...
  return /*#__PURE__*/React.createElement("label", _extends({
    ...
    style: {
      ...
      height: 28,
      borderRadius: 999,
      background: checked ? 'var(--accent-primary)' : 'var(--cocoa-200)',
...
function DayStrip({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    }, d.date, marks[d.date] && /*#__PURE__*/React.createElement("span", {
      style: {
        position: 'absolute',
        bottom: 5,
        width: 4,
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      style: {
        ...
        padding: '0 5px',
        borderRadius: 999,
        background: on ? 'var(--surface-gold)' : 'var(--cocoa-200)',
        color: 'var(--cocoa-800)',
        font: 'var(--type-overline)'
      }
    }, count));
...
function TabBar({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    }, it.logo ? /*#__PURE__*/React.createElement(__ds_scope.LogoMark, {
      size: 22
    }) : /*#__PURE__*/React.createElement(__ds_scope.Icon, {
      name: it.icon,
      size: 22
...
function ContributeScreen({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Screen, {
  ...
  }, /*#__PURE__*/React.createElement(SectionHead, null, "Pay with"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 10
    ...
    sub: '•• 4821'
  }].map(m => /*#__PURE__*/React.createElement(ListRow, {
    key: m.id,
    icon: m.icon,
    iconTone: m.tone,
    title: m.title,
    subtitle: m.sub,
    avatar: m.logo ? /*#__PURE__*/React.createElement(PayLogo, {
      provider: m.logo,
      size: 38
    }) : undefined,
  ...
  }, "Goes straight to Sona Bih, who collects this round."))), /*#__PURE__*/React.createElement(Sheet, {
    open: confirm,
    title: "All good?",
    ...
    }, "Send ", Number(amount).toLocaleString(), " FCFA")
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/njangi_app/ContributeScreen.jsx", error: String((e && e.message) || e) }); }
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/njangi_app/Frame.jsx", error: String((e && e.message) || e) }); }
...
function GroupScreen({
  ...
  }, "Pot this cycle"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'baseline',
      gap: 6,
  ...
  }, g.pot), /*#__PURE__*/React.createElement("span", {
    style: {
      font: 'var(--type-body-sm)',
      color: 'color-mix(in oklab, var(--white) 78%, transparent)'
    }
  }, "FCFA"))), /*#__PURE__*/React.createElement(Badge, {
    tone: "gold",
    icon: "repeat"
  }, g.cycle.split(' · ')[1])), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 18
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement("span", null, g.cycle.split(' · ')[0]), /*#__PURE__*/React.createElement("span", null, g.progress, "% through")), /*#__PURE__*/React.createElement("div", {
    style: {
      height: 8,
      borderRadius: 999,
      background: 'color-mix(in oklab, var(--white) 28%, transparent)',
      overflow: 'hidden'
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "Pay my share \xB7 ", g.share, " FCFA")), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 28
    }
  ...
  }, MEMBERS.map((m, i) => /*#__PURE__*/React.createElement(ListRow, {
    key: m.name,
    avatar: /*#__PURE__*/React.createElement(Avatar, {
      name: m.name,
      size: "md",
  ...
  }, /*#__PURE__*/React.createElement(SectionHead, null, "Group rules"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 10
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/njangi_app/GroupScreen.jsx", error: String((e && e.message) || e) }); }
...
function HomeScreen({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Screen, null, /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'flex-start',
      justifyContent: 'space-between',
  ...
  }, "Morning, Ada"), /*#__PURE__*/React.createElement("div", {
    style: {
      font: 'var(--type-body-sm)',
      color: 'var(--text-muted)',
      marginTop: 4
    }
  }, "Thursday, 10 March")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 8,
      alignItems: 'center'
  ...
  }, "Across 4 njangis"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'baseline',
      gap: 6,
  ...
  }, "1,640,000"), /*#__PURE__*/React.createElement("span", {
    style: {
      font: 'var(--type-body-sm)',
      color: 'var(--cocoa-300)'
    }
  }, "FCFA"))), /*#__PURE__*/React.createElement(IconButton, {
    icon: "eye",
    tone: "soft",
    style: {
    ...
    onClick: onContribute
  }, "Put in"), /*#__PURE__*/React.createElement(Button, {
    variant: "secondary",
    size: "md",
    icon: "hand-coins",
    style: {
  ...
  }, "Ndolo Ladies is due tomorrow"), /*#__PURE__*/React.createElement("div", {
    style: {
      font: 'var(--type-body-sm)',
      color: 'var(--cocoa-700)',
      marginTop: 4
    }
  }, "25,000 FCFA. Six of eight have paid."), /*#__PURE__*/React.createElement(Button, {
    variant: "dark",
    size: "sm",
    style: {
      marginTop: 12
    }
  }, "Pay my share")), /*#__PURE__*/React.createElement(ProgressRing, {
    value: 75,
    size: 78,
    thickness: 9,
    tone: "dark",
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/njangi_app/HomeScreen.jsx", error: String((e && e.message) || e) }); }
...
function ProfileScreen() {
  ...
  return /*#__PURE__*/React.createElement(Screen, null, /*#__PURE__*/React.createElement("div", {
  ...
  }, "Ada Nkeng"), /*#__PURE__*/React.createElement("div", {
    style: {
      font: 'var(--type-body-sm)',
      color: 'var(--text-muted)',
      marginTop: 2
    }
  }, "+237 6 77 21 40 09 \xB7 Douala"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 8,
      justifyContent: 'center',
    ...
    tone: "gold",
    icon: "trophy"
  }, "17 clean rounds")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 10,
      marginTop: 18
  ...
  }, "Share my code"))), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 12,
      display: 'grid',
      gridTemplateColumns: '1fr 1fr 1fr',
  ...
  }, /*#__PURE__*/React.createElement(SectionHead, null, "Reminders"), /*#__PURE__*/React.createElement(Card, {
    pad: 16
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/njangi_app/ProfileScreen.jsx", error: String((e && e.message) || e) }); }
...
function SignInScreen({
  ...
  return /*#__PURE__*/React.createElement(PhoneFrame, null, /*#__PURE__*/React.createElement("div", {
  ...
  }, "Save together,", /*#__PURE__*/React.createElement("br", null), "collect in turn."), /*#__PURE__*/React.createElement("p", {
    style: {
      font: 'var(--type-body)',
      color: 'var(--text-muted)',
      marginTop: 12
    }
  }, "Put in the same amount every round. One person collects each time. We keep the record straight.")), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 32,
      display: 'flex',
      flexDirection: 'column',
    ...
    onClick: onDone
  }, "Send me a code"), /*#__PURE__*/React.createElement(Button, {
    variant: "ghost",
    size: "md",
    block: true,
    icon: "ticket",
    onClick: onDone
  }, "I have an invite code"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 12,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/njangi_app/SignInScreen.jsx", error: String((e && e.message) || e) }); }
...
function WalletScreen() {
  ...
  return /*#__PURE__*/React.createElement(Screen, null, /*#__PURE__*/React.createElement("div", {
  ...
  }, "Put in this year"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'baseline',
      gap: 6,
  ...
  }, "FCFA"))), /*#__PURE__*/React.createElement(ProgressRing, {
    value: 68,
    size: 72,
    thickness: 8,
    tone: "gold",
  ...
  }, [38, 52, 44, 68, 58, 84, 62, 74, 90, 56, 70, 46].map((h, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      flex: 1,
      height: '100%',
    ...
    style: {
      font: 'var(--type-overline)',
      color: i === 8 ? 'var(--text-heading)' : 'var(--text-faint)'
    }
  }, 'JFMAMJJASOND'[i]))))), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 12,
      display: 'grid',
      gridTemplateColumns: '1fr 1fr',
  ...
  }, rows[tab].map((r, i) => /*#__PURE__*/React.createElement(ListRow, {
    key: i,
  ...
  }, /*#__PURE__*/React.createElement(SectionHead, null, "Payment methods"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 10
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/njangi_app/WalletScreen.jsx", error: String((e && e.message) || e) }); }
...
function Hero({
  ...
  return /*#__PURE__*/React.createElement(Section, {
  ...
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Eyebrow, null, "Rotating savings, done right"), /*#__PURE__*/React.createElement("h1", {
    style: {
  ...
  }, "Everyone puts in the same amount each round. One person collects each time. Njangi keeps the order, sends the reminders and shows the whole group who has paid."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 12,
      marginTop: 30
    ...
    iconAfter: "arrow-right",
    onClick: onStart
  }, "Start a njangi"), /*#__PURE__*/React.createElement(Button, {
    variant: "secondary",
    size: "lg",
    icon: "play"
  ...
  }, "12,400 groups"), " across Cameroon, Gabon and Chad"))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      justifyContent: 'center'
    }
    ...
    style: {
      ...
      inset: '-40px -30px',
      borderRadius: '50%',
      background: 'radial-gradient(circle at 50% 45%, var(--clay-100), transparent 70%)'
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'relative',
  ...
  }, "Ndolo Ladies \xB7 pot this cycle"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'baseline',
      gap: 6,
  ...
  }, "480,000"), /*#__PURE__*/React.createElement("span", {
    style: {
      font: 'var(--type-body-sm)',
      color: 'var(--cocoa-300)'
    }
  ...
  }, /*#__PURE__*/React.createElement("span", null, "Six of eight paid"), /*#__PURE__*/React.createElement("span", null, "Round 3 of 8")))), /*#__PURE__*/React.createElement(ListRow, {
    avatar: /*#__PURE__*/React.createElement(Avatar, {
      name: "Sona Bih",
      ring: "gold",
      size: "md"
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/njangi_web/Hero.jsx", error: String((e && e.message) || e) }); }
...
function HowItWorks() {
  ...
  }, "The same njangi you already run. Less arguing about who paid.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
...
function Numbers() {
  ...
  }, "Groups keep going because nobody has to keep the book."), /*#__PURE__*/React.createElement("p", {
    style: {
      font: 'var(--type-body)',
      color: 'var(--cocoa-300)',
      marginTop: 16,
  ...
  }, "Reminders go out before the deadline, not after. Every payment lands in one shared record the whole group can see."), /*#__PURE__*/React.createElement(Button, {
    variant: "gold",
    size: "lg",
    iconAfter: "arrow-right",
    style: {
  ...
  }, "Start a njangi")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gridTemplateColumns: '1fr 1fr',
      gap: 12
...
function Testimonial() {
  ...
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Eyebrow, null, "From the groups"), /*#__PURE__*/React.createElement("h2", {
    style: {
      font: 'var(--weight-semibold) var(--text-2xl)/1.15 var(--font-display)',
      marginTop: 12
    }
  }, "What members tell us")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 8
    }
...
function Pricing() {
  const plans = [{
    ...
    feats: ['Shared payment record', 'Reminders before the deadline', 'MoMo and Orange Money', 'Payout order by draw'],
    cta: 'Start a njangi',
    tone: 'plain'
  }, {
    name: 'Group plus',
    ...
    feats: ['Everything in Group', 'Unlimited members', 'Export the cycle record', 'Late-fee tracking', 'Two group admins'],
    cta: 'Choose plus',
    tone: 'accent'
  }, {
    name: 'Association',
    ...
    feats: ['Many groups in one place', 'Treasurer roles', 'Bank settlement', 'Onsite onboarding'],
    cta: 'Contact sales',
    tone: 'plain'
  }];
  return /*#__PURE__*/React.createElement(Section, {
  ...
  }, /*#__PURE__*/React.createElement(Eyebrow, null, "Fees"), /*#__PURE__*/React.createElement("h2", {
    style: {
      font: 'var(--weight-semibold) var(--text-3xl)/1.1 var(--font-display)',
      letterSpacing: 'var(--tracking-tight)',
      marginTop: 14
    }
  }, "We don't take a cut of your pot."), /*#__PURE__*/React.createElement("p", {
    style: {
      font: 'var(--type-body)',
      color: 'var(--text-muted)',
      marginTop: 12
    }
  }, "Most groups never pay us anything. Bigger ones pay per cycle, not per member.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
    ...
    }, p.name), on && /*#__PURE__*/React.createElement(Badge, {
      tone: "gold"
    }, "Most groups")), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        alignItems: 'baseline',
        gap: 6,
    ...
    }, p.price), p.price !== 'Free' && p.price !== 'Talk to us' && /*#__PURE__*/React.createElement("span", {
      style: {
        font: 'var(--type-body-sm)',
...
function Faq() {
  const items = [['Who holds the money?', 'Nobody. When a round closes, the money moves from each member straight to whoever is collecting. Njangi never sits in the middle of it.'], ['What if someone stops paying?', "The group sees it the day it happens. You can charge the late fee you agreed on, or move that person's turn to the back."], ['Can we change the payout order?', 'Yes, but everyone has to agree in the app. We keep a record of the change so nobody can dispute it later.'], ['Does it work without data?', 'Reminders go out by SMS, and you can pay from the USSD menu if you are offline.']];
  ...
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Eyebrow, null, "Questions"), /*#__PURE__*/React.createElement("h2", {
    style: {
      font: 'var(--weight-semibold) var(--text-2xl)/1.15 var(--font-display)',
      marginTop: 12
    }
  }, "The things groups ask first"), /*#__PURE__*/React.createElement("p", {
    style: {
      font: 'var(--type-body-sm)',
      color: 'var(--text-muted)',
      marginTop: 12
    }
  }, "Still stuck? We answer on WhatsApp, usually within the hour."), /*#__PURE__*/React.createElement(Button, {
    variant: "secondary",
    size: "md",
    icon: "message-circle",
    style: {
  ...
  }, "Message us")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 10
    }
  }, items.map(([q, a], i) => /*#__PURE__*/React.createElement(Card, {
    key: q,
    tone: "outlined",
    radius: "xl",
    pad: 18,
...
function FinalCta({
  ...
  }, "Get your group on it this week."), /*#__PURE__*/React.createElement("p", {
    style: {
      font: 'var(--type-body)',
      fontSize: 'var(--text-md)',
  ...
  }, "Set it up in about five minutes. Invite the people you already save with \u2014 they don't need to sign up before they can see the group.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 10,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/njangi_web/Sections.jsx", error: String((e && e.message) || e) }); }
...
function SiteHeader({
  ...
  }, ['How it works', 'For groups', 'Trust & safety', 'Help'].map(l => /*#__PURE__*/React.createElement("a", {
    key: l,
    href: "#",
    style: {
      font: 'var(--type-body-sm)',
...
function Section({
  ...
  const bg = tone === 'inset' ? 'var(--bg-inset)' : tone === 'dark' ? 'var(--cocoa-900)' : 'transparent';
  return /*#__PURE__*/React.createElement("section", {
    style: {
      background: bg,
      padding: '84px 0',
...
function SiteFooter() {
  const cols = [['Product', ['How it works', 'For groups', 'Fees', 'Download']], ['Company', ['About', 'Careers', 'Press', 'Contact']], ['Trust', ['Security', 'Terms', 'Privacy', 'Complaints']]];
  ...
  }, "The savings group you already run, with the record keeping taken off your hands."), /*#__PURE__*/React.createElement(SocialLinks, {
    networks: ['whatsapp', 'facebook', 'instagram'],
    size: 36,
    style: {
      marginTop: 18
  ...
  }, /*#__PURE__*/React.createElement("span", null, "\xA9 2026 Njangi. Douala, Cameroon."), /*#__PURE__*/React.createElement("span", null, "Amounts shown in FCFA"))));
}
Object.assign(window, {
  SiteHeader,
  Section,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/njangi_web/Site.jsx", error: String((e && e.message) || e) }); }
